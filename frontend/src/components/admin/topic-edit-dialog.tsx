...
export function TopicEditDialog({ topic, open, onOpenChange, onSuccess }: TopicEditDialogProps) {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            // If we have a video URL and it changed, update via PUT /api/video/:id
            if (videoUrl && videoUrl !== topic.video_url) {
                await updateVideo(topic.id, { title, url: videoUrl })
            }

            // TODO: update topic title/description if backend supports it
